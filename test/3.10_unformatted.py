...
def lookAtThisMethod(first_parameter, second_paramter = None, third_parameter = 32, fourth_parameter="a short string as default argument", **kwargs):
  ...
  We are done!
  """
  return kwargs[  'whatever'   ](first_parameter*third_parameter,second_paramter, fourth_parameter, 'extra string because I want to')
...
def main():
  ...
  match len(argv):
    case 0:
      print ( "Zero args" )
    case 1: print ( "one arg" )
    case 2|3: print ( "two or three args" )
    case [4, 5, 6]: print ( "4 to six args" )
    case _:
      print ( "more args" )
  ...
  z = {
    "another" : "map",
      "of": 3,
    "values" : [ 12345678,12345678,12345678,12345678,12345678,12345678,12345678,12345678, ]
  }
